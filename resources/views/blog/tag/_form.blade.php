...
<div class="form-group">
  ...
  <div class="col-md-4">
      <input type="text" class="form-control" name="layout" id="layout" value="layouts.master">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-7">
    <label class="radio-inline">
      <input type="radio" name="reverse_direction" id="reverse_direction" value="0"> Normal
    </label>
    <label class="radio-inline">
      <input type="radio" name="reverse_direction" value="1"> Reversed
    </label>
  </div>
</div>